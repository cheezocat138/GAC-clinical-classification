...
def main():
    ...
    train_parser.add_argument('-d', '--data', default=DATA_PATHS['rppa_with_survival'], 
                             help='训练数据文件路径')
    ...
    predict_parser.add_argument('-r', '--rppa', default=DATA_PATHS['rppa_transposed'],
                               help='RPPA数据文件路径')
    ...
    analyze_parser.add_argument('-r', '--rppa', default=DATA_PATHS['rppa_transposed'],
                               help='RPPA数据文件路径')
    ...
    if args.command == 'train':
        ...
        print(f"开始预测，使用RPPA数据: {args.rppa}")
        ...
        print(f"开始生存分析，使用RPPA数据: {args.rppa}")
